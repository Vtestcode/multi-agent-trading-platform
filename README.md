...
- `POLYGON_API_KEY` is still required for historical bars, news, and indicator/tool computations.
...
- Autonomous scans use a random 5-ticker subset from the default universe on each run to reduce Polygon request pressure.
